// Now we add a second layer of Perlinnoise by multiplying it to the first noise Layer. Bright and dark spots amplify each other, opposite magnitudes cancel each other out.
